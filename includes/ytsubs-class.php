 ...
 class Youtube_Subs_Widget extends WP_Widget {
    ...
    function __construct() {
      parent::__construct(
        ...
        array( 'description' => esc_html__( 'Widget to display YouTube subs', 'yts_domain' ), ) // Arguments
      );
    }
    ...
    public function widget( $args, $instance ) {
      echo $args['before_widget']; // Display divs before the widget

      // Display divs or arguments before or after the widget title
      ...
      echo $args['after_widget']; // Display divs after the widget
    }
    ...
    public function form( $instance ) {
      ...
      $channel = ! empty( $instance['channel'] ) ? $instance['channel'] : esc_html__( 'UC-YfashN3AgXIASuUpNUC1w', 'yts_domain' ); 
